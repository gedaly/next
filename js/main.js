...
function setDefaultState() {
  ...
  baseState[id] = {
    status: "new",
    id: id,
    title: "Create a list of simple actions steps to improve your resilience"
  };
  syncState(baseState);
}
...
function addItem(text, status, id, noUpdate) {
  ...
  $(".form-control")
    .val("")
    .attr("placeholder", "✏️ What's next?");
  setTimeout(function() {
...
var randomWordArray = Array(
  "Take good care of yourself this fine ",
  "It's be good to yourself ",
  "Oh my, it's ",
  "Yay, it's ",
  "Happy ",
  "Todos for ",
